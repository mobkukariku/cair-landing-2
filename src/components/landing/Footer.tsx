...
export default function Footer() {
  return (
    <footer className="w-full bg-[#01034D] text-white">
      <div className="py-12">
        <div className="mx-auto px-6 md:px-[120px]">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-8 text-[18px] text-white font-medium">
              <p>Head Office: Almaty region, Kaskelen city, <br /> Abylaikhan street, 1/1</p>
          ...
          <div className="space-y-8">
            ...
            <nav className="space-y-2">
              {["Home", "Services", "Why us", "Partners", "Contact"].map((item) => (
                <a
                  key={item}
                  href="#"
